...
CKEDITOR.config={customConfig:"my-apps/note/config.js",autoUpdateElement:!0,language:"",defaultLanguage:"en",contentsLangDirection:"",enterMode:CKEDITOR.ENTER_P,forceEnterMode:!1,shiftEnterMode:CKEDITOR.ENTER_BR,docType:"\x3c!DOCTYPE html\x3e",bodyId:"",bodyClass:"",fullPage:!1,height:200,contentsCss:CKEDITOR.getUrl("my-apps/note/contents.css"),extraPlugins:"",removePlugins:"",protectedSource:[],tabIndex:0,width:"",baseFloatZIndex:1E4,blockedKeystrokes:[CKEDITOR.CTRL+66,CKEDITOR.CTRL+73,CKEDITOR.CTRL+85]};
...
this.detect(d,a));var c=this;d=function(){c[a].dir=c.rtl[a]?"rtl":"ltr";b(a,c[a])};this[a]?d():CKEDITOR.scriptLoader.load(CKEDITOR.getUrl("my-apps/note/lang/"+a+".js"),d,this)},detect:function(a,d){var b=this.languages;d=d||navigator.userLanguage||navigator.language||a;var c=d.toLowerCase().match(/([a-z]+)(?:-([a-z]+))?/),e=c[1],c=c[2];b[e+"-"+c]?e=e+"-"+c:b[e]||(e=null);CKEDITOR.lang.detect=e?function(){return e}:function(a){return a};return e||a}}})();
...
[]);k[f].push(v)}}CKEDITOR.scriptLoader.load(g,function(a,e){if(e.length)throw Error('[CKEDITOR.resourceManager.load] Resource name "'+k[e[0]].join(",")+'" was not found at "'+e[0]+'".');for(var f=0;f<a.length;f++)for(var g=k[a[f]],n=0;n<g.length;n++){var w=g[n];l[w]=this.get(w);c[w]=1}d.call(b,l)},this)}};CKEDITOR.plugins=new CKEDITOR.resourceManager("my-apps/note/plugins/","plugin");
...
else{var d=this,b=d.config.stylesCombo_stylesSet||d.config.stylesSet;if(!1===b)a(null);else if(b instanceof Array)d._.stylesDefinitions=b,a(b);else{b||(b="default");var b=b.split(":"),c=b[0];CKEDITOR.stylesSet.addExternal(c,b[1]?b.slice(1).join(":"):CKEDITOR.getUrl("my-apps/note/styles.js"),"");CKEDITOR.stylesSet.load(c,function(b){d._.stylesDefinitions=b[c];a(d._.stylesDefinitions)})}}}});
...
CKEDITOR.status="loaded";CKEDITOR.fireOnce("loaded");if(a=CKEDITOR._.pending)for(delete CKEDITOR._.pending,d=0;d<a.length;d++)CKEDITOR.editor.prototype.constructor.apply(a[d][0],a[d][1]),CKEDITOR.add(a[d][0])})();CKEDITOR.skin.name="flat";CKEDITOR.skin.ua_editor="ie,iequirks,ie7,ie8,gecko";CKEDITOR.skin.ua_dialog="ie,iequirks,ie7,ie8";
...
null},increment:function(a){this.getLast(a).inputs++},remove:function(a){a=this.getLastIndex(a);-1!=a&&this.stack.splice(a,1)},resetInputs:function(a){if("number"==typeof a)this.getLast(a).inputs=0;else for(a=this.stack.length;a--;)this.stack[a].inputs=0},getTotalInputs:function(){for(var a=this.stack.length,b=0;a--;)b+=this.stack[a].inputs;return b},cleanUp:function(a){a=a.data.$;a.ctrlKey||a.metaKey||this.remove(17);a.shiftKey||this.remove(16);a.altKey||this.remove(18)}}})();(function(){var b={readOnly:1,exec:function(a){if(a.fire("save")&&(a=a.element.$.form))try{a.submit()}catch(b){a.submit.click&&a.submit.click()}}};CKEDITOR.plugins.add("allowsave",{init:function(a){a.addCommand("save",b).modes={wysiwyg:1,source:1};a.ui.addButton&&a.ui.addButton("Save",{label:a.lang.allowsave.toolbar,command:"save",toolbar:"document,10"})}})})();CKEDITOR.plugins.add("notification",{requires:"toolbar",init:function(b){function a(b){var a=new CKEDITOR.dom.element("div");a.setStyles({position:"fixed","margin-left":"-9999px"});a.setAttributes({"aria-live":"assertive","aria-atomic":"true"});a.setText(b);CKEDITOR.document.getBody().append(a);setTimeout(function(){a.remove()},100)}b._.notificationArea=new Area(b);b.showNotification=function(a,d,e){var g,m;"progress"==d?g=e:m=e;a=new CKEDITOR.plugins.notification(b,{message:a,type:d,progress:g,duration:m});
...
2-f/2?a.setStyle("left",k(n-e.x+p.x)):a.setStyle("left",k(n+d.width/2-f/2-h/2))}};CKEDITOR.plugins.notification=Notification;(function(){function k(a){var b=null!=a.config.autosave_SaveKey?a.config.autosave_SaveKey:"autosave_"+window.location+"_"+a.id,g=null!=a.config.autosave_NotOlderThen?a.config.autosave_NotOlderThen:1440,c=null!=a.config.autosave_saveOnDestroy?a.config.autosave_saveOnDestroy:!1,d=null!=a.config.autosave_saveDetectionSelectors?a.config.autosave_saveDetectionSelectors:"a[href^\x3d'javascript:__doPostBack'][id*\x3d'Save'],a[id*\x3d'Cancel']";CKEDITOR.scriptLoader.load(CKEDITOR.getUrl(CKEDITOR.plugins.getPath("autosave")+
...
newTextLines:d,opcodes:f,baseTextName:b.lang.autosave.loadedContent,newTextName:b.lang.autosave.autoSavedContent+moment(c.saveTime).locale(b.config.language).format(b.lang.autosave.dateFormat)+"'",contextSize:3,viewType:"inline"==a.getContentElement("general","diffType").getValue()?1:0}).outerHTML+"\x3c/div\x3e")}if(function(){if("undefined"===typeof Storage)return!1;try{return localStorage.getItem("___test_key"),!0}catch(a){return!1}}()){CKEDITOR.plugins.add("autosave",{requires:"notification",version:.13,
init:function(a){CKEDITOR.document.appendStyleSheet(CKEDITOR.getUrl(CKEDITOR.plugins.getPath("autosave")+"css/autosave.min.css"));a.on("instanceReady",function(){"undefined"===typeof jQuery?CKEDITOR.scriptLoader.load("//ajax.googleapis.com/ajax/libs/jquery/1/jquery.min.js",function(){jQuery.noConflict();k(a)}):CKEDITOR.scriptLoader.load(CKEDITOR.getUrl(CKEDITOR.plugins.getPath("autosave")+"js/extensions.min.js"),function(){k(a)})},a,null,100)}});var c=0,f=!1,l=function(a){c||(c=setTimeout(q,1E3*(null!=
CKEDITOR.config.autosave_delay?CKEDITOR.config.autosave_delay:5),a))},q=function(a){if(f)l(a);else if(a.editor.checkDirty()||a.editor.plugins.bbcode)f=!0,a=a.editor,m(null!=a.config.autosave_SaveKey?a.config.autosave_SaveKey:"autosave_"+window.location+"_"+a.id,a),c=0,f=!1}}else CKEDITOR.plugins.add("autosave",{})})();CKEDITOR.config.plugins='dialogui,dialog,about,basicstyles,clipboard,button,toolbar,enterkey,entities,floatingspace,wysiwygarea,indent,indentlist,fakeobjects,link,list,undo,allowsave,notification,autosave';CKEDITOR.config.skin='flat';(function() {var setIcons = function(icons, strip) {var path = CKEDITOR.getUrl( 'my-apps/note/plugins/' + strip );icons = icons.split( ',' );for ( var i = 0; i < icons.length; i++ )CKEDITOR.skin.icons[ icons[ i ] ] = { path: path, offset: -icons[ ++i ], bgsize : icons[ ++i ] };};if (CKEDITOR.env.hidpi) setIcons('about,0,,bold,24,,italic,48,,strike,72,,subscript,96,,superscript,120,,underline,144,,copy-rtl,168,,copy,192,,cut-rtl,216,,cut,240,,paste-rtl,264,,paste,288,,indent-rtl,312,,indent,336,,outdent-rtl,360,,outdent,384,,anchor-rtl,408,,anchor,432,,link,456,,unlink,480,,bulletedlist-rtl,504,,bulletedlist,528,,numberedlist-rtl,552,,numberedlist,576,,redo-rtl,600,,redo,624,,undo-rtl,648,,undo,672,,save,696,','icons_hidpi.png');else setIcons('about,0,auto,bold,24,auto,italic,48,auto,strike,72,auto,subscript,96,auto,superscript,120,auto,underline,144,auto,copy-rtl,168,auto,copy,192,auto,cut-rtl,216,auto,cut,240,auto,paste-rtl,264,auto,paste,288,auto,indent-rtl,312,auto,indent,336,auto,outdent-rtl,360,auto,outdent,384,auto,anchor-rtl,408,auto,anchor,432,auto,link,456,auto,unlink,480,auto,bulletedlist-rtl,504,auto,bulletedlist,528,auto,numberedlist-rtl,552,auto,numberedlist,576,auto,redo-rtl,600,auto,redo,624,auto,undo-rtl,648,auto,undo,672,auto,save,696,auto','icons.png');})();CKEDITOR.lang.languages={"en":1};}());